...
//    }
    ...
    public Item toEntity() {
        return new Item(id, book_id, book_image, book_title, book_author, publisher, pub_date, major_kategory, minor_kategory, list_price, sell_price, book_condition, book_detail, book_infor, purchase_price);
    }
}