...
public class membersForm {
  ...
  private String member_member_id; //회원 아이디
  ...
  public Member toEntity() {
    return new Member(id, member_member_id, member_name, member_mail, member_password, member_nickname, bank_name, bankAccount, member_phone, member_addr, postcode, member_addr_2, recommend_id, member_detail, e_money, member_role, member_mileage);
  }
}
